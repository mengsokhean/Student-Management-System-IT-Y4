...
<body class="min-h-screen bg-gray-900 flex items-center justify-center">
    ...
    <div class="w-full max-w-md bg-gray-800 rounded-2xl shadow-2xl p-8">
        ...
        <form method="POST" action="{{ route('admin.login.submit') }}">
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    value="{{ old('email') }}"
                    required autofocus
                    class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
        ...
        <p class="text-center text-gray-500 text-sm mt-6">
            <a href="/teacher/login" class="text-indigo-400 hover:underline">Teacher login →</a>
        </p>
    </div>
