  ...
  return (
    <aside className="w-60 min-h-screen bg-slate-900 flex flex-col flex-shrink-0">
      ...
      <div className="px-4 py-5 border-b border-slate-700">
        <div className="flex items-center gap-3">
          ...
          <div className="overflow-hidden">
            <p className="text-white font-bold text-sm leading-tight truncate">វិទ្យាល័យហ៊ុនសែន</p>
      ...
      <div className="px-4 py-4 border-b border-slate-700">
        <div className="flex items-center gap-3">
          <div className={`w-9 h-9 ${role.color} rounded-lg flex items-center justify-center flex-shrink-0`}>
            <span className="material-icons text-white text-lg">{role.icon}</span>
          </div>
          <div className="overflow-hidden flex-1">
            <p className="text-white text-sm font-semibold truncate">{user?.name}</p>
            <span className="text-xs text-slate-400">{role.kh}</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-3 border-t border-slate-700 space-y-0.5">
        <button
          ...
          className="w-full sidebar-link-inactive"
        >
